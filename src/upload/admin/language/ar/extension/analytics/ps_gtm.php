...
$_['text_troubleshot']              = '<ul><li><strong>لم يتم العثور على معرّف القياس:</strong> تحقق جيدًا من أنك أدخلت معرّف القياس الصحيح في إعدادات الإضافة. تأكد من عدم وجود مسافات إضافية أو أحرف غير صحيحة.</li><li><strong>العلامات لا تعمل:</strong> تأكد من أن علاماتك تم تكوينها بشكل صحيح في Google Tag Manager باستخدام المشغلات الصحيحة. يمكنك استخدام <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> لاستكشاف مشكلات تشغيل العلامات وإصلاحها.</li><li><strong>مشكلات الأذونات:</strong> تأكد من أن لديك الأذونات اللازمة في حساب Google Tag Manager الخاص بك لإنشاء العلامات وإدارتها.</li><li><strong>مشكلات التوافق:</strong> تأكد من أن إصدار OpenCart الخاص بك حديث، وتحقق من عدم وجود أي إضافات أخرى مثبتة تتعارض مع إعداد Google Tag Manager.</li></ul>';
