...
$_['text_getting_started']          = '<p><strong>Přehled:</strong> Rozšíření Playful Sparkle - Google Tag Manager pro OpenCart 4 umožňuje snadno spravovat a nasazovat marketingové značky ve vašem obchodě OpenCart bez znalosti programování. S tímto rozšířením můžete zjednodušit nastavení sledování, což zlepší analytiku a marketingovou efektivitu.</p><p><strong>Požadavky:</strong> Zajistěte si účet Google Tag Manager, platný ID Google Tag Manager a používejte kompatibilní verzi OpenCart.</p>';
