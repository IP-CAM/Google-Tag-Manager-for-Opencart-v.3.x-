...
$_['text_troubleshot']              = '<ul><li><strong>ID Google Tag Manageru nebyl nalezen:</strong> Důkladně zkontrolujte, zda jste správně zadali ID Google Tag Manageru v nastavení rozšíření. Ujistěte se, že neobsahuje žádné nadbytečné mezery nebo nesprávné znaky.</li><li><strong>Značky se nespouštějí:</strong> Ujistěte se, že vaše značky jsou správně nastaveny v Google Tag Manageru s odpovídajícími spouštěči. Můžete použít <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> k diagnostice problémů se spouštěním značek.</li><li><strong>Problémy s oprávněními:</strong> Ujistěte se, že máte potřebná oprávnění ve svém účtu Google Tag Manager pro vytváření a správu značek.</li><li><strong>Problémy s kompatibilitou:</strong> Ujistěte se, že vaše verze OpenCart je aktuální a ověřte, že žádná jiná nainstalovaná rozšíření nekonflikují s nastavením Google Tag Manageru.</li></ul>';
$_['text_faq']                      = '<details><summary>Co dělat, když se mi značky ve Google Tag Manageru nespouští?</summary>Ujistěte se, že vaše ID Google Tag Manageru je správné, a ověřte, že jsou značky publikovány a správně nastaveny s odpovídajícími spouštěči.</details><details><summary>Jak mohu zkontrolovat, zda rozšíření funguje?</summary>Využijte rozšíření <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> pro Chrome nebo režim náhledu v Google Tag Manageru, abyste potvrdili, že se vaše značky spouští, jak očekáváte.</details><details><summary>Je toto rozšíření kompatibilní s jinými rozšířeními?</summary>I když je toto rozšíření obecně kompatibilní, doporučuje se otestovat ho s jinými rozšířeními nainstalovanými na vašem webu, abyste se vyhnuli konfliktům. Pokud narazíte na problémy, zkontrolujte známé problémy s kompatibilitou.</details><details><summary>Jak řešit běžné problémy se značkami?</summary>Odkazujte na příručku pro řešení problémů Google Tag Manager pro pomoc s běžnými problémy se značkami a nejlepšími postupy pro konfiguraci.</details>';
