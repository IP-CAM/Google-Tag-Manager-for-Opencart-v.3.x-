...
$_['text_troubleshot']              = '<ul><li><strong>Google Tag Manager-ID nicht gefunden:</strong> Überprüfen Sie, ob Sie die richtige Google Tag Manager-ID in den Einstellungen der Erweiterung eingegeben haben. Achten Sie darauf, dass keine zusätzlichen Leerzeichen oder falschen Zeichen vorhanden sind.</li><li><strong>Tags werden nicht ausgelöst:</strong> Stellen Sie sicher, dass Ihre Tags im Google Tag Manager mit den richtigen Triggern korrekt konfiguriert sind. Sie können den <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> verwenden, um Probleme mit dem Auslösen von Tags zu beheben.</li><li><strong>Zugriffsprobleme:</strong> Stellen Sie sicher, dass Sie über die erforderlichen Berechtigungen in Ihrem Google Tag Manager-Konto verfügen, um Tags zu erstellen und zu verwalten.</li><li><strong>Kompatibilitätsprobleme:</strong> Stellen Sie sicher, dass Ihre OpenCart-Version auf dem neuesten Stand ist, und überprüfen Sie, ob keine anderen installierten Erweiterungen mit der Einrichtung des Google Tag Managers in Konflikt stehen.</li></ul>';
$_['text_faq']                      = '<details><summary>Was ist, wenn ich meine Tags im Google Tag Manager nicht sehe?</summary>Stellen Sie sicher, dass Ihre Google Tag Manager-ID korrekt ist und dass die Tags veröffentlicht und mit den richtigen Triggern konfiguriert sind.</details><details><summary>Wie kann ich überprüfen, ob die Erweiterung funktioniert?</summary>Verwenden Sie die <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a>-Chrome-Erweiterung oder den Vorschau-Modus im Google Tag Manager, um zu bestätigen, dass Ihre Tags wie erwartet ausgelöst werden.</details><details><summary>Ist diese Erweiterung mit anderen Erweiterungen kompatibel?</summary>Diese Erweiterung ist im Allgemeinen kompatibel, es wird jedoch empfohlen, sie mit anderen auf Ihrer Website installierten Erweiterungen zu testen, um Konflikte zu vermeiden. Wenn Sie auf Probleme stoßen, überprüfen Sie bekannte Kompatibilitätsprobleme.</details><details><summary>Wie behebe ich häufige Tag-Probleme?</summary>Verweisen Sie auf den Leitfaden zur Fehlersuche im Google Tag Manager, um Hilfe bei häufigen Tag-Problemen und bewährten Praktiken für die Konfiguration zu erhalten.</details>';
...
$_['help_gtm_id_locate']            = 'Um Ihre Google Tag Manager-ID zu finden, melden Sie sich in Ihrem <a href="https://tagmanager.google.com" target="_blank" rel="external noopener noreferrer">Google Tag Manager-Konto</a> an. Suchen Sie im Arbeitsbereich die ID oben im Dashboard—sie beginnt mit "GTM-" gefolgt von einer einzigartigen Reihe von Buchstaben und Zahlen, wie "GTM-XXXXXXX". <a href="https://support.google.com/analytics/answer/12270356?hl=de" target="_blank" rel="external noopener noreferrer">Hier finden Sie detailliertere Anweisungen</a>.';
