...
$_['heading_fix']                  = 'Επιδιόρθωση συνηθισμένων σφαλμάτων';
...
$_['text_troubleshot']              = '<ul><li><strong>Μη Βρέθηκε Measurement ID:</strong> Ελέγξτε ξανά ότι έχετε εισαγάγει το σωστό Measurement ID στις ρυθμίσεις της επέκτασης. Βεβαιωθείτε ότι δεν υπάρχουν επιπλέον κενά ή λανθασμένοι χαρακτήρες.</li><li><strong>Οι Ετικέτες Δεν Ενεργοποιούνται:</strong> Βεβαιωθείτε ότι οι ετικέτες σας έχουν ρυθμιστεί σωστά στο Google Tag Manager με τους σωστούς ενεργοποιητές. Μπορείτε να χρησιμοποιήσετε το <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> για να αντιμετωπίσετε προβλήματα ενεργοποίησης ετικετών.</li><li><strong>Προβλήματα Δικαιωμάτων:</strong> Βεβαιωθείτε ότι έχετε τα απαραίτητα δικαιώματα στον λογαριασμό σας Google Tag Manager για να δημιουργείτε και να διαχειρίζεστε ετικέτες.</li><li><strong>Προβλήματα Συμβατότητας:</strong> Βεβαιωθείτε ότι η έκδοση του OpenCart είναι ενημερωμένη και ελέγξτε ότι καμία άλλη εγκατεστημένη επέκταση δεν έρχεται σε σύγκρουση με τη ρύθμιση του Google Tag Manager.</li></ul>';
