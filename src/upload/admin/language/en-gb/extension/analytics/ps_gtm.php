...
$_['text_troubleshot']              = '<ul><li><strong>Google Tag Manager ID Not Found:</strong> Double-check that you’ve entered the correct Google Tag Manager ID in the extension settings. Ensure there are no extra spaces or incorrect characters.</li><li><strong>Tags Not Firing:</strong> Ensure that your tags are properly configured in Google Tag Manager with the correct triggers. You can use the <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> to troubleshoot tag firing issues.</li><li><strong>Permissions Issues:</strong> Make sure you have the necessary permissions in your Google Tag Manager account to create and manage tags.</li><li><strong>Compatibility Issues:</strong> Ensure your OpenCart version is up-to-date and verify that no other installed extensions are conflicting with the Google Tag Manager setup.</li></ul>';
$_['text_faq']                      = '<details><summary>What if I don’t see my tags firing in Google Tag Manager?</summary>Ensure that your Google Tag Manager ID is correct, and verify that the tags are published and properly configured with the right triggers.</details><details><summary>How can I check if the extension is working?</summary>Utilize the <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> Chrome extension or the preview mode in Google Tag Manager to confirm that your tags are firing as expected.</details><details><summary>Is this extension compatible with other extensions?</summary>While this extension is generally compatible, it is advisable to test it with other extensions installed on your site to avoid conflicts. If you encounter issues, check for known compatibility problems.</details><details><summary>How do I troubleshoot common tag issues?</summary>Refer to the Google Tag Manager troubleshooting guide for help with common tag issues and best practices for configuration.</details>';
