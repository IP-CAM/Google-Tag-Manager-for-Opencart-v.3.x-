...
$_['text_troubleshot']              = '<ul><li><strong>Measurement ID Not Found:</strong> Double-check that you’ve entered the correct Measurement ID in the extension settings. Ensure there are no extra spaces or incorrect characters.</li><li><strong>Tags Not Firing:</strong> Ensure that your tags are properly configured in Google Tag Manager with the correct triggers. You can use the <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> to troubleshoot tag firing issues.</li><li><strong>Permissions Issues:</strong> Make sure you have the necessary permissions in your Google Tag Manager account to create and manage tags.</li><li><strong>Compatibility Issues:</strong> Ensure your OpenCart version is up-to-date and verify that no other installed extensions are conflicting with the Google Tag Manager setup.</li></ul>';
