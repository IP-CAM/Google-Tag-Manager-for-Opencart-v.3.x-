...
$_['text_getting_started']          = '<p><strong>Áttekintés:</strong> A Playful Sparkle - Google Tag Manager bővítmény az OpenCart 3-hoz lehetővé teszi a marketingcímkék egyszerű kezelését és telepítését az OpenCart boltjában, programozói tudás nélkül. Ezzel a bővítménnyel optimalizálhatja a nyomkövetési beállításait, lehetővé téve a jobb analitikát és a hatékonyabb marketinget.</p><p><strong>Előfeltételek:</strong> Biztosítsa, hogy rendelkezik Google Tag Manager fiókkal, érvényes Google Tag Manager azonosítóval, és hogy kompatibilis OpenCart 3.x+, PHP 7.3 verziót használ.</p>';
