...
$_['help_gtm_id_locate']            = 'Per trovare il tuo ID di Misurazione, accedi al tuo <a href="https://tagmanager.google.com" target="_blank" rel="external noopener noreferrer">account Google Tag Manager</a>. Nel workspace, cerca l\'ID in cima alla dashboard: inizia con "GTM-" seguito da una serie unica di lettere e numeri, come "GTM-XXXXXXXX". <a href="https://support.google.com/analytics/answer/12270356?hl=en" target="_blank" rel="external noopener noreferrer">Istruzioni dettagliate qui</a>.';
