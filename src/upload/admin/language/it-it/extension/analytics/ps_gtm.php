...
$_['text_troubleshot']              = '<ul><li><strong>ID di Misurazione Non Trovato:</strong> Verifica di aver inserito correttamente l\'ID di Misurazione nelle impostazioni dell\'estensione. Assicurati che non ci siano spazi extra o caratteri errati.</li><li><strong>I Tag Non Vengono Eseguiti:</strong> Verifica che i tuoi tag siano configurati correttamente in Google Tag Manager con i trigger giusti. Puoi usare <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> per risolvere eventuali problemi nell\'esecuzione dei tag.</li><li><strong>Problemi di Permessi:</strong> Assicurati di avere i permessi necessari nel tuo account Google Tag Manager per creare e gestire i tag.</li><li><strong>Problemi di Compatibilità:</strong> Assicurati che la tua versione di OpenCart sia aggiornata e verifica che nessuna altra estensione installata stia causando conflitti con la configurazione di Google Tag Manager.</li></ul>';
...
$_['help_gtm_id_locate']            = 'Per trovare il tuo ID di Misurazione, accedi al tuo <a href="https://tagmanager.google.com" target="_blank" rel="external noopener noreferrer">account Google Tag Manager</a>. Nel workspace, cerca l\'ID in cima alla dashboard: inizia con "GTM-" seguito da una serie unica di lettere e numeri, come "GTM-XXXXXXX". <a href="https://support.google.com/analytics/answer/12270356?hl=en" target="_blank" rel="external noopener noreferrer">Istruzioni dettagliate qui</a>.';
...
$_['error_gtm_id_invalid']          = 'Il formato dell\'ID di GTM è errato. Assicurati che segua il formato GTM-XXXXXXX.';
