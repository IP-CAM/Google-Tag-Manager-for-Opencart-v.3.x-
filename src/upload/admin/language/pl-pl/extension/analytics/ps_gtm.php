...
$_['text_troubleshot']              = '<ul><li><strong>Nie znaleziono identyfikatora pomiaru:</strong> Sprawdź dokładnie, czy wprowadziłeś poprawny identyfikator pomiaru w ustawieniach rozszerzenia. Upewnij się, że nie ma dodatkowych spacji ani nieprawidłowych znaków.</li><li><strong>Tagi nie są uruchamiane:</strong> Upewnij się, że Twoje tagi są poprawnie skonfigurowane w Google Tag Manager z prawidłowymi wyzwalaczami. Możesz użyć <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> do rozwiązywania problemów z uruchamianiem tagów.</li><li><strong>Problemy z uprawnieniami:</strong> Upewnij się, że masz niezbędne uprawnienia na swoim koncie Google Tag Manager do tworzenia i zarządzania tagami.</li><li><strong>Problemy z kompatybilnością:</strong> Upewnij się, że Twoja wersja OpenCart jest aktualna i sprawdź, czy inne zainstalowane rozszerzenia nie powodują konfliktów z konfiguracją Google Tag Manager.</li></ul>';
